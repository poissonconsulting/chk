...
test_that("cc with atomic vectors", {
  ...
  expect_identical(cc(c(1,1), " or "), "1 or 1")
  expect_identical(cc(1:2, " or "), "1 or 2")
  expect_identical(cc(1:2), "1, 2")
  expect_identical(cc(1:3, " or "), "1, 2 or 3")
  expect_identical(cc(1:10, " or "), "1, 2, 3, 4, 5, 6, 7, 8, 9 or 10")
  expect_identical(cc(1:11, " or "), "1, 2, 3, 4, 5, 6, 7, 8, ... or 11")
  expect_identical(cc(11:1, " or "), "11, 10, 9, 8, 7, 6, 5, 4, ... or 1")
  expect_identical(cc(11:1, brac = "'"), 
                   "'11', '10', '9', '8', '7', '6', '5', '4', ..., '1'")
})
...
test_that("cc with random objects", {
  ...
  expect_identical(cc(matrix(1:9, 3), " or "), "1, 2, 3, 4, 5, 6, 7, 8 or 9")
})
