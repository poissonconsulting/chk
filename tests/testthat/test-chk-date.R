...
test_that("check_date", {
  expect_identical(check_date(as.Date("2000-01-01")), as.Date("2000-01-01"))
  expect_invisible(check_date(as.Date("2000-01-01")))

  expect_chk_error(check_date(1), "^`1` must be a date [(]non-missing Date scalar[)][.]$")
  expect_chk_error(check_date(1, x_name = "2001-02-04"), "^2001-02-04 must be a date [(]non-missing Date scalar[)][.]$")
})
