...
test_that("err", {
  ...
  expect_error(
    err("there %r %n problem value%s", n = 1),
  ...
  expect_error(
    err("there %r %n problem value%s", n = 1.5),
    "there are 1.5 problem values"
  )
  expect_error(
    err("there %r %n problem value%s", n = 0),
...
test_that("msg", {
  ...
  expect_message(
    msg("there %r %n problem value%s", n = 1.5),
    "there are 1.5 problem values"
  )
  expect_message(
    msg("there %r %n problem value%s", n = 0),
    "there are 0 problem values"
  )
})
...
test_that("wrn", {
  ...
  expect_warning(
    wrn("there %r %n problem value%s", n = 1.5),
    "there are 1.5 problem values"
  )
  expect_warning(
    wrn("there %r %n problem value%s", n = 0),
    "there are 0 problem values"
  )
})
