...
and almost all `chk_` functions are standalone.
This allows developers to easily copy and paste individual functions into their package
...
As exemplified by `chk_flag`, almost all the `chk_` functions immediately evaluate their 
