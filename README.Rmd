...
`chk` is released under the [CC0](https://creativecommons.org/publicdomain/zero/1.0/) license.
This allows developers to copy and paste functions into their package
which is useful if they want to minimize their dependencies.
Most of the `chk_` functions are standalone, ie, written in base R.

Copied functions should not be exported (to avoid namespace conflicts) and the CC0 creditation preserved.
```r
#  License: CC0
