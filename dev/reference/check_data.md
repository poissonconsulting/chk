...
[`unique()`](https://rdrr.io/r/base/unique.html) on a lubridate `Period`
vector discards everything but the seconds, which collapses `values` and
silently changes the check applied (see
